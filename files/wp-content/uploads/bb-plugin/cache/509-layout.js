...
$(this.nodeClass+" .uabb-slide-main").vTicker('init',{speed:this.speed,pause:this.pause,mousePause:this.mousePause,});}}};})(jQuery);jQuery(document).ready(function($){new UABBFancyText({id:'5eeaa51454683',viewport_position:90,animation:'type',strings:["When do I bring my child to the dentist?"],typeSpeed:80,startDelay:200,backSpeed:100,backDelay:2000,loop:false,showCursor:true,cursorChar:'|'});});jQuery(function($){$(function(){$('.fl-node-5ece00b77d90e .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){jQuery(document).ready(function(){if(typeof jQuery.fn.waypoint!=='undefined'){$('.fl-node-5ecea7bf1a36c .uabb-info-list-icon').waypoint({offset:'90%',handler:function(e){jQuery(this.element).addClass('pulse animated');}});}});})(jQuery);