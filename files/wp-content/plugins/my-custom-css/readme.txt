...
Contributors: esthertyler
Tags: css, style, custom, code snippets, plugin, stylesheet, ace, cloud9 editor, run PHP, insert PHP, Header, Footer, ads, use PHP, PHP plugin, ads, adsense, ad rotation, shortcoder, ad inserter, Header, Footer, ad manager, amp ads, amazon, ad blocking detection, header code, banner, banners, advert, adverts, sticky fixed widgets
Author: esthertyler
Author URI: https://profiles.wordpress.org/esthertyler
...
* New dev: https://profiles.wordpress.org/esthertyler
* Author Homepage: [Esther Tyler](http://mycustomcss.com/)
...
* Update Support/Author link to: <a href="http://mycustomcss.com/">http://mycustomcss.com/</a>
