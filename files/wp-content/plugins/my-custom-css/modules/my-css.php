...
{
    if ($file == plugin_basename(MYCC_PLUGIN_DIR))
    {
...
function plug_ver()
{
    $plugin_data = get_plugin_data(MYCC_PLUGIN_DIR);
...
function mycustomcss_scripts()
{
	...
	<script type="text/javascript" src="'.plugin_dir_url(MYCC_PLUGIN_DIR).'assets/editor/_scrolltop.js?plug_ver='.plug_ver().'"></script>';
    if(!isset($_POST['viewbackup']) && !isset($_POST['erasebackup']))
    {
        echo '
	<!-- Ace Editor -->
	<script type="text/javascript" src="'.plugin_dir_url(MYCC_PLUGIN_DIR).'assets/editor/ace.js?plug_ver='.plug_ver().'" charset="utf-8"></script>
	<script type="text/javascript" src="'.plugin_dir_url(MYCC_PLUGIN_DIR).'assets/editor/ext-searchbox.js?plug_ver='.plug_ver().'" charset="utf-8"></script>
	<script type="text/javascript" src="'.plugin_dir_url(MYCC_PLUGIN_DIR).'assets/editor/ext-language_tools.js?plug_ver='.plug_ver().'" charset="utf-8"></script>
	...
	<script type="text/javascript" src="'.plugin_dir_url(MYCC_PLUGIN_DIR).'assets/editor/textresizer/cookie.js?plug_ver='.plug_ver().'"></script>
	<script type="text/javascript" src="'.plugin_dir_url(MYCC_PLUGIN_DIR).'assets/editor/textresizer/textresizer.min.js?plug_ver='.plug_ver().'"></script>
	<script type="text/javascript" src="'.plugin_dir_url(MYCC_PLUGIN_DIR).'assets/editor/textresizer/textresizer_target.js?plug_ver='.plug_ver().'"></script>';
    }
    echo '
	<!-- CSS Code -->
	<link rel="stylesheet" id="ace-editor-custom-css" href="'.MYCC_PLUGIN_URL.'/assets/editor/ace_custom.css?plug_ver='.plug_ver().'" type="text/css" media="all" />
...
add_filter('plugin_action_links_'.plugin_basename(MYCC_PLUGIN_DIR).'', 'mycustomcss_links');
