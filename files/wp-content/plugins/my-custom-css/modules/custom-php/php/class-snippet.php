 ...
 * @property string   $code_type      default|shortcode . Easy is shortcode helper
 *
...
class MyPHPCode {
	...
	private function prepare_tags( $tags ) {
		return custom_php_build_tags_array( $tags );
	}
	...
	public static function get_all_scopes() {
		return array( 'global', 'admin', 'front-end', 'single-use', 'shortcode' );
	}
