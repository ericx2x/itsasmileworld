...
class Helper
{
    static function hasShortode($content, $shortcode){
    ...
    static function default_settings() {
        ...
        foreach ( self::settings_fields() as $section_id => $fields ) {
    ...
    static function menuUrl($slug) {
        return admin_url('admin.php?page='.MYCC_MENU_PREFIX . $slug);
    }
